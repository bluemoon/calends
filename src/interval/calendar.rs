  ...
  pub fn succ(&self) -> Self {
    match self.period {
      CalendarBasis::Year => {
        ...
        let end = addition::add_year_duration(start);
      ...
      CalendarBasis::Quarter => {
        let start = self.end_date().unwrap().succ();
        let end = addition::add_quarter_duration(start);
      ...
      CalendarBasis::BiWeek => {
        let start = self.end_date().unwrap().succ();
        let end = addition::add_biweek_duration(start);
      ...
      CalendarBasis::Week => {
        let start = self.end_date().unwrap().succ();
        let end = addition::add_week_duration(start);
      ...
      CalendarBasis::Day => {
        let start = self.end_date().unwrap().succ();
        let end = addition::add_day(start);
